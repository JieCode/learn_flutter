          ...
          children: <Widget>[
            Checkbox(
                ...
                onChanged: (value){
                  ...
                  flag = value!;
                  print("HYContentBody value: $value");
                }
            ),
            Text(
              '同意协议',
...
class HYContentBody2 extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return HYContentState2();
  }
}

class HYContentState2 extends State<HYContentBody2>{
  var flag = true;
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
          ...
          children: <Widget>[
            Checkbox(
                ...
                onChanged: (value){
                  ...
                  //                 print("value: $value");
                  // 是因为在Dart中，$value是一个变量，而不是一个常量，Center之前被我定义成const，所以报错了，删除即可
                  this.setState(() { // 需要把需要修改状态的代码放到setState中才能刷新UI
                    // 重新构建
                    flag = value!;
                  });
                  print("HYContentBody2 value: $value");
                }
            ),
            Text(
              '同意协议',
